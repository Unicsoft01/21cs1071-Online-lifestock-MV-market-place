...
<div class="col-lg-12 py-5">
    <div class="contain-fluid">
                ...
                <div class="container-fluid">
                    ...
                    <div class="welcome-content">
                                    ...
                                    <a href="./?page=products/view_product&id=<?= $row['id'] ?>" class="card shadow rounded-0 text-reset text-decoration-none">
                                        ...
                                        <div class="card-body border-top border-gray">
                                            ...
                                            <div class="d-flex">
                                                ...
                                                <div class="col-auto px-0 flex-shrink-1 flex-grow-1">
                                                    <p class="m-0 pl-3"><small class="text-success"><?= format_num($row['price']) ?></small></p>
                                                </div>
                                            </div>
                        ...
                        <div class="text-center">
                            <a href="./?page=products" class="btn btn-large btn-success rounded-pill col-lg-3 col-md-5 col-sm-12">Explore More Products</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card card-outline card-dark shadow rounded-0">
            <div class="card-body rounded-0">
                <div class="container-fluid">
                    <h3 class="text-center">Project Submitted By Shaibu PeterYoung</h3>
                    <hr>
                    <div class="welcome-content text-center">
                        Mat: 21CS1071 | UNDER THE SUPERVISION OF MR. JOHNSON APKA | CLASS OF 2024
                    <?php //include("welcome.html") 
                    ?>
                    </div>
                </div>
        ...
        <div class="clear-fix mb-3"></div>
        <?php include_once "products/index.php"; ?>
    </div>
</div>